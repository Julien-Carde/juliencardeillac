            ...
            <div className={styles.aboutContainer}>
                ...
                <div className={styles.aboutSection}>
                    ...
                    <p className={styles.aboutText}>
                        Hello! I am Julien Cardeillac, a 23-year-old engineer with a passion for 3D graphics, coding and creative innovation.
                        ...
                        <br />
                        <p className={styles.optionalText}>Whether working on full-stack applications, 3D modeling or animation, I am dedicated to continually building my skills, learning from experienced teams, and contributing to innovative projects that merge technology with art.
